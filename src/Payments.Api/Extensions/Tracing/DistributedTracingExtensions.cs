...
namespace Payments.Api.Extensions.Tracing
{
    /// <summary>
    ...
    {
        private static readonly ActivitySource ActivitySource = new("FiapPosTech.Payments");

        /// <summary>
        /// Configura OpenTelemetry Distributed Tracing para Payments API
        /// </summary>
        public static IServiceCollection AddDistributedTracing(this IServiceCollection services, IConfiguration configuration)
        {
            var serviceName = "fiap-payments-api";
